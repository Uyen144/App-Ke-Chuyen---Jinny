...
class AudioVietnam extends StatefulWidget {
  @override
  State<AudioVietnam> createState() => _AudioVietnamState();
}

class _AudioVietnamState extends State<AudioVietnam> {
  ...
  Future<void> loadFile() async {
    await player.setSource(AssetSource('audio/tamcam.mp3'));
    await player.setVolume(1);
  }

  Future<void> loop() async {
    player.setReleaseMode(ReleaseMode.loop);
    player.setSource(AssetSource('audio/tamcam.mp3'));
  }
